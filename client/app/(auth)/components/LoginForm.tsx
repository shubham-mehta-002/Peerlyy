...
export const LoginForm = ({ form, onSubmit }: { form: ReturnType<typeof useForm<z.infer<typeof loginFormSchema>>>, onSubmit: (data: z.infer<typeof loginFormSchema>) => void }) => {
    return (
        <>
            <CardContent>
                <form id="form-rhf-demo" onSubmit={form.handleSubmit(onSubmit)}>
                    <FieldGroup>
                        ...
                        <Button className="py-3"><p className="cursor-pointer text-sm text-shadow-muted-foreground">Login</p></Button>
